...
# class F1(BaseMetric):
#     """
#     Calculates the F1 score using torchmetrics.
#     """

#     def __init__(
#         self, num_classes: int, device: str = "auto", average="macro", name="f1"
#     ):
...
#         self.metric = MulticlassF1Score(num_classes=num_classes, average=average).to(
#             device
#         )
...
#         Returns:
#             float: The F1 score for the batch.
#         """
...
class F1(BaseMetric):
    """
    Calculates the F1 score using torchmetrics correctly.
    """
    ...
    def compute(self):
        """
        Computes the F1 score over all batches seen since the last reset.
        Returns:
            float: The final F1 score.
        """
